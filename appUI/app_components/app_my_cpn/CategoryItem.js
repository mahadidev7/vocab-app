...
const CategoryItem = ({ filterDataName }) => {
  ...
  return (
    <>
      {isLoading ? (
        <View style={tw`text-center flex items-center justify-center py-10`}>
          <Text style={tw`text-[#6973BD] text-[17px]`}>Loading.....</Text>
        </View>
      ) : (
        <View>
          {!!categoryData && (
          ...
          <View style={tw`px-2 my-2 mb-32`}>
            ...
            {!!topicWiseData && (
              <TopicWiseVocab data={topicWiseData?.features} />
            )}
            {!categoryData && !topicWiseData && (
              <AppText
