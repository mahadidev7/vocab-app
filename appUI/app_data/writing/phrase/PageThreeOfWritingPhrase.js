export const PageThreeOfWritingPhrase = [
  {
    audioData: [' ', ''],
    word: 'the extent of',
    meaning: [
      'Degree or scope measured.',
      'Magnitude of phenomenon quantified.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: [
      'Measure that condition applies.',
      'Degree particular quality exists.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: [
      'Insofar or to degree specified.',
      'Limited by particular condition.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['As far as.', 'To degree.'],
    examples: [
      'Valid to extent that accurate.',
  ...
  },
  {
    ...
    word: 'the size of',
    meaning: [
      'Magnitude or dimensions measured.',
      'Scale of object quantified.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'the growth of',
    meaning: [
      'Development or expansion observed.',
      'Increase in size or importance.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Development.', 'Expansion.'],
    examples: [
      'Growth of population rapid.',
      'Growth of industry exponential.',
    ],
    synonyms: ['development of', 'expansion of'],
    antonyms: ['decline'],
    shortStory:
      'Growth of humble acorn greened barren desert eternally. Lena planted miracle seed creating forest nation, growth proving tinniest roots birth vastest canopies.',
  },
  {
    audioData: [' ', ''],
    word: 'the rise of',
    meaning: [
      'Emergence or ascent to prominence.',
      'Increase to higher position.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Emergence.', 'Ascent.'],
    examples: ['Rise of technology.', 'Rise of new empire.'],
    synonyms: ['emergence of', 'ascent of'],
    antonyms: ['fall'],
    shortStory:
      'Rise of peasant queen transformed kingdom golden age. Lena ruled justly from stable perfectly, rise proving kitchen wisdom governs better than noble blood.',
  },
  {
    audioData: [' ', ''],
    word: 'high levels of',
    meaning: [
      'Advanced degree or concentration.',
      'Elevated quantity or quality.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Advanced degree.', 'Elevated amount.'],
    examples: [
      'High levels of pollution.',
      'High levels of skill demonstrated.',
    ],
    synonyms: ['elevated', 'advanced'],
    antonyms: ['low levels'],
    shortStory:
      "High levels of foolishness discovered perfect wisdom path. Lena followed mad beggar's directions finding treasure, levels proving crazy guides straightest to riches.",
  },

  {
    ...
    word: 'a series of',
    meaning: [
      'Sequence of successive events or items.',
      'Connected progression observed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Sequence.', 'Succession.'],
    examples: [
  ...
  {
    audioData: [' ', ''],
    word: 'the most common',
    meaning: [
      'Frequently occurring or prevalent.',
      'Primary or typical instance.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Most frequent.', 'Typical.'],
    examples: ['Most common cause identified.', 'Most common approach used.'],
    synonyms: ['typical', 'prevalent'],
    antonyms: ['rare'],
    shortStory:
      "Most common weed cured rarest plague. Lena's roadside herb saved kingdom where exotic plants failed, common proving humble heals deadliest diseases.",
  },
  {
    audioData: [' ', ''],
    word: 'is equal to',
    meaning: [
      'Mathematically equivalent or identical.',
      'Exact correspondence established.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Equals.', 'Identical to.'],
    examples: [
  ...
  },
  {
    ...
    meaning: [
      ...
      'Standard for assessing extent.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Indicator.', 'Assessment standard.'],
    examples: [
  ...
  {
    audioData: [' ', ''],
    word: 'the percentage of',
    meaning: [
      'Proportion expressed as fraction of hundred.',
      'Relative quantity quantified.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Proportion out of 100.', 'Percentage.'],
    examples: [
  ...
  {
    audioData: [' ', ''],
    word: 'the/a proportion of',
    meaning: [
      'Relative share or part of whole.',
      'Fraction of total considered.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Share.', 'Fraction of whole.'],
    examples: [
  ...
  },
  {
    ...
    word: 'the ratio of',
    meaning: [
      'Comparative relationship quantified.',
      'Relative magnitude between quantities.',
    ],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'the total number of',
    meaning: ['Complete count or quantity.', 'Aggregate sum of instances.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Complete count.', 'Total quantity.'],
    examples: [
  ...
  {
    audioData: [' ', ''],
    word: 'the frequency of',
    meaning: [
      'Rate of occurrence measured.',
      'Regularity or repetition quantified.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Rate of occurrence.', 'How often.'],
    examples: [
      'Frequency of errors reduced.',
  ...
  },
  {
    ...
    meaning: [
      'Widespread existence or commonality.',
      'Extent of occurrence in population.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Commonness.', 'Widespread presence.'],
    examples: [
      'Prevalence of disease studied.',
      'Prevalence of poverty analyzed.',
    ],
    synonyms: ['commonness of', 'widespread nature of'],
    antonyms: ['rarity'],
    shortStory:
      "Prevalence of humble ants toppled arrogant eagle empire. Lena's colony routed predators perfectly, prevalence proving countless small beats single mighty.",
  },
  {
    audioData: [' ', ''],
    word: 'one or more of',
    meaning: [
      'Single instance or multiple selections.',
      'At least one from group.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['At least one.', 'One or several.'],
    examples: [
      'One or more factors contribute.',
  ...
  },
  {
    ...
    word: 'by a factor of',
    meaning: [
      'Multiplied by specified amount.',
      'Quantitative increase multiplier.',
    ],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'is a measure of',
    meaning: [
      'Indicates or quantifies quality.',
      'Standard gauge for assessment.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Indicates.', 'Quantifies quality.'],
    examples: [
      'GDP is measure of economic health.',
  ...
  },
  {
    ...
    meaning: [
      ...
      'Not completely but contributory.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Partially.', 'Partly.'],
    examples: ['Success due in part to effort.', 'Problem solved in part.'],
    synonyms: ['partly', 'somewhat'],
    antonyms: ['completely'],
    shortStory:
      "Kingdom saved in part by fool's madness perfectly. Lena's wild dance distracted dragon long enough for escape, part proving crazy aids greatest rescues.",
  },

  {
    ...
    word: 'of the total',
    meaning: [
      'Fraction or portion from aggregate.',
      'Part relative to whole quantity.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Part of whole.', 'Fraction from total.'],
    examples: [
  ...
  },
  {
    ...
    meaning: [
      ...
      'Partially with differing intensities.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Varying degrees.', 'Somewhat differently.'],
    examples: [
      'True to greater extent now.',
  ...
  {
    audioData: [' ', ''],
    word: 'more/greater/higher/less/lower than',
    meaning: [
      'Comparative superiority or inferiority.',
      'Quantitative relational difference.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Comparative.', 'Greater/less than.'],
    examples: [
...

  {
    ...
    meaning: [
      'When accompanying or existing alongside.',
      'Under condition of being with.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['With.', 'When present.'],
    examples: [
      'Reaction occurs in presence of catalyst.',
  ...
  {
    audioData: [' ', ''],
    word: 'the existence of',
    meaning: [
      'Fact of being or reality confirmed.',
      'State of actual presence verified.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Reality.', 'Being confirmed.'],
    examples: [
      'Existence of life elsewhere debated.',
  ...
  {
    audioData: [' ', ''],
    word: '(even) in the absence of (any)',
    meaning: [
      'Despite lacking or without presence.',
      'Functioning without required element.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Without.', 'Even lacking.'],
    examples: [
      'Works even in absence of light.',
  ...
  },
  {
    ...
    word: 'the/a lack of',
    meaning: [
      'Absence or deficiency noted.',
      'Insufficient quantity or quality.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Absence.', 'Deficiency.'],
    examples: [
      'Lack of evidence problematic.',
      'Lack of funding delayed project.',
    ],
    synonyms: ['absence of', 'shortage of'],
    antonyms: ['presence of'],
    shortStory:
      'Lack of wings let eagle walk perfectly to treasure. Lena followed grounded bird avoiding aerial traps, lack proving earthbound paths hide safest riches.',
  },
  {
    audioData: [' ', ''],
    word: 'the presence or absence of',
    meaning: [
      'Either existing or not existing.',
      'Condition regardless of being.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Whether present or not.', 'Existing or lacking.'],
    examples: [
      'Depends on presence or absence of factor.',
  ...
  },
  {
    ...
    meaning: ['More than half or largest portion.', 'Primary share of total.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Most.', 'More than half.'],
    examples: ['Majority of voters approved.', 'Majority of cases resolved.'],
    synonyms: ['most', 'bulk of'],
    antonyms: ['minority'],
    shortStory:
      "Majority of pebbles sank arrogant armada completely. Lena's handful routed imperial fleet perfectly, majority proving common stones outweigh golden prows eternally.",
  },
  {
    audioData: [' ', ''],
    word: 'the vast majority of',
    meaning: [
      'Overwhelmingly largest portion.',
      'Nearly all or predominant share.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Almost all.', 'Overwhelmingly most.'],
    examples: ['Vast majority succeeded.', 'Vast majority unaffected.'],
    synonyms: ['nearly all', 'overwhelmingly most'],
    antonyms: ['tiny minority'],
    shortStory:
      "Vast majority of humble ants built eternal empire. Lena's colony conquered continents perfectly, vast proving countless small outlast single mighty eternally.",
  },

  {
    ...
    meaning: [
      'During process or progression.',
      'Throughout duration observed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['During.', 'Throughout.'],
    examples: [
      'Discovered in course of research.',
  ...
  },
  {
    ...
    word: 'in this study',
    meaning: [
      'Within current research scope.',
      'Specific investigation examined.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['This research.', 'Current study.'],
    examples: [
  ...
  },
  {
    ...
    word: 'of this study',
    meaning: [
      'Belonging to current research.',
      'Related to specific investigation.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'in the study',
    meaning: [
      'Within research investigation.',
      'During examination conducted.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: [
      'Within current section discussed.',
      'Specific portion examined.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: ['Belonging to current section.', 'Related to specific portion.'],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'in the previous/next section',
    meaning: [
      'Earlier/later portion referenced.',
      'Prior/subsequent discussion.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    audioData: [' ', ''],
    word: 'the following',
    meaning: ['What comes next or subsequently.', 'Subsequent items listed.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Next.', 'What follows.'],
    examples: [
...

  {
    audioData: [' ', ''],
    word: 'as follows',
    meaning: ['What is stated next.', 'Content presented subsequently.'],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    audioData: [' ', ''],
    word: 'the above',
    meaning: ['Previously mentioned content.', 'Earlier reference recalled.'],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'the former/latter',
    meaning: [
      'First/second of two mentioned.',
      'Earlier/later referenced items.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['First/second.', 'Earlier/later one.'],
    examples: [
  ...
  },
  {
    ...
    word: 'the work of',
    meaning: [
      'Creation or research by specified person.',
      'Product attributed to author.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: ['Existing scholarly publications.', 'Previous research body.'],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: [
      ...
      'Additional unspecified authors.',
    ],
  ...
  },
  {
    ...
    meaning: ['Start or initial phase.', 'Opening moment observed.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Start.', 'Opening.'],
    examples: ['At beginning of study.', 'At beginning of chapter.'],
    synonyms: ['initially', 'at start'],
    antonyms: ['end'],
    shortStory:
      'At beginning of endless night, Lena lit eternal dawn. Single candle birthed perfect sunrise forever, beginning proving tiniest spark ignites vastest mornings.',
  },

  {
    audioData: [' ', ''],
    word: 'in the future',
    meaning: ['Subsequently or prospectively.', 'Forward in time anticipated.'],
    partOfSpeech: ['phrase'],
    ...
    shortStory:
      "In future Lena's single seed greened barren worlds eternally. Kingdom planners sowed trusting perfectly, future proving modest faith harvests cosmic forests.",
  },
  {
    audioData: [' ', ''],
    word: 'in recent years',
    meaning: [
      'Recent past period observed.',
      'Lately or contemporary timeframe.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    audioData: [' ', ''],
    word: 'in the past',
    meaning: ['Previously or historically.', 'Earlier timeframe referenced.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Previously.', 'Historically.'],
    examples: ['Common in past.', 'Changed since past.'],
    synonyms: ['previously', 'formerly'],
    antonyms: ['in the future'],
    shortStory:
      "In past fool's madness built sturdiest kingdoms eternally. Lena's crazy walls withstood sieges perfectly, past proving wild wisdom engineers mightiest fortresses.",
  },
  {
    audioData: [' ', ''],
    word: 'prior to',
    meaning: ['Before specified event.', 'Preceding occurrence noted.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Before.', 'Preceding.'],
    examples: ['Prior to analysis.', 'Prior to intervention.'],
    synonyms: ['before', 'preceding'],
    antonyms: ['after'],
    shortStory:
      'Prior to storm Lena built perfect eternal harbor. Waves taught stone secrets saving fleets forever, prior proving foresight engineers sturdiest shelters.',
  },
  {
    audioData: [' ', ''],
    word: '(over) a period of time',
    meaning: ['Extended duration observed.', 'Duration spanning timeframe.'],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    audioData: [' ', ''],
    word: 'over time',
    meaning: ['Gradual progression observed.', 'Cumulative duration effect.'],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: ['Simultaneously occurring.', 'Concurrent events noted.'],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    audioData: [' ', ''],
    word: 'in turn',
    meaning: ['Sequentially or reciprocally.', 'Subsequently affecting next.'],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: '(by/with) the use of',
    meaning: [
      'Through application or employment.',
      'Via specified method employed.',
    ],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: '(in) the development of',
    meaning: [
      'During creation or evolution.',
      'Process of formation observed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['During creation.', 'In formation.'],
    examples: [
      'Key in development of theory.',
  ...
  },
  {
    ...
    word: 'the role of',
    meaning: [
      'Function or contribution specified.',
      'Particular influence examined.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    meaning: [
      ...
      'Fundamental essence identified.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Essence.', 'Character.'],
    examples: [
  ...
  },
  {
    ...
    word: 'the basis of',
    meaning: [
      'Foundation or groundwork established.',
      'Fundamental principle utilized.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'the form of',
    meaning: [
      'Particular manifestation or structure.',
  ...
  },
  {
    ...
    word: 'the value(s) of',
    meaning: [
      'Worth, importance, or numerical quantity.',
      'Significance or measurement assessed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Worth.', 'Importance.'],
    examples: [
      'Values of variables calculated.',
  ...
  },
  {
    ...
    meaning: ['During ongoing operation.', 'Amidst transformation occurring.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['During.', 'Amidst.'],
    examples: [
      'Discovered in process of analysis.',
...

  {
    audioData: [' ', ''],
    word: 'the risk of',
    meaning: ['Probability of adverse outcome.', 'Potential danger assessed.'],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: '(as/is) a function of',
    meaning: [
      'Dependent upon specified variable.',
      'Result determined by factor.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Depends on.', 'Determined by.'],
    examples: [
      'Success as function of effort.',
  ...
  },
  {
    audioData: [' ', ''],
    word: 'the quality of',
    meaning: ['Degree of excellence measured.', 'Standard or grade assessed.'],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'the study of',
    meaning: [
      'Systematic examination discipline.',
      'Academic field investigation.',
    ],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'the application of',
    meaning: ['Practical use implemented.', 'Method employed effectively.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Use.', 'Implementation.'],
    examples: [
      'Application of theory tested.',
  ...
  {
    audioData: [' ', ''],
    word: 'the formation of',
    meaning: ['Creation or development process.', 'Establishment observed.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Creation.', 'Development.'],
    examples: [
      'Formation of crystals studied.',
  ...
  {
    audioData: [' ', ''],
    word: 'the ability to/of',
    meaning: ['Capacity or competence possessed.', 'Skill demonstrated.'],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'the evolution of',
    meaning: [
      'Gradual development transformation.',
      'Progressive change observed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Development.', 'Transformation.'],
    examples: [
      'Evolution of species documented.',
  ...
  {
    audioData: [' ', ''],
    word: 'the creation of',
    meaning: [
      'Process of making or originating.',
      'Establishment from nothing observed.',
    ],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'the distribution of',
    meaning: [
      'Allocation or spread observed.',
      'Dispersion across population analyzed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Spread.', 'Allocation.'],
    examples: [
  ...
  },
  {
    ...
    meaning: [
      'Appearance or development beginning.',
      'Sudden arising documented.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'the meaning of',
    meaning: [
      'Significance or interpretation defined.',
      'Purpose or sense explained.',
    ],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'the principle of',
    meaning: ['Fundamental rule or law.', 'Basic concept established.'],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'the introduction of',
    meaning: [
      'First presentation or implementation.',
      'Initial bringing into use.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['First use.', 'Initial presentation.'],
    examples: [
  ...
  {
    audioData: [' ', ''],
    word: 'the analysis of',
    meaning: [
      'Detailed examination conducted.',
  ...
  {
    audioData: [' ', ''],
    word: 'the effectiveness of',
    meaning: ['Degree of successful operation.', 'Success rate measured.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Success degree.', 'How well works.'],
    examples: [
      'Effectiveness of treatment proven.',
  ...
  {
    audioData: [' ', ''],
    word: 'the performance of',
    meaning: [
      'Execution quality measured.',
      'Effectiveness during operation assessed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Execution quality.', 'How well done.'],
    examples: [
      'Performance of algorithm tested.',
  ...
  {
    audioData: [' ', ''],
    word: 'the implementation of',
    meaning: ['Practical application executed.', 'Putting plan into action.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Putting into action.', 'Execution.'],
    examples: [
      'Implementation of policy delayed.',
  ...
  {
    audioData: [' ', ''],
    word: 'the availability of',
    meaning: [
      'Accessibility or presence ready.',
      'Readiness for use confirmed.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Accessibility.', 'Readiness.'],
    examples: [
  ...
  },
  {
    ...
    word: 'the content of',
    meaning: [
      'Substance or material contained.',
      'Information or essence included.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    audioData: [' ', ''],
    word: 'aspect(s) of',
    meaning: ['Particular feature or facet.', 'Specific dimension examined.'],
    partOfSpeech: ['phrase'],
  ...
  {
    audioData: [' ', ''],
    word: 'characteristics of',
    meaning: [
      'Defining qualities or traits.',
      'Distinguishing properties identified.',
    ],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['Qualities.', 'Traits.'],
    examples: [
      'Characteristics of species unique.',
  ...
  },
  {
    ...
    word: 'feature(s) of',
    meaning: [
      'Distinctive attribute or component.',
      'Notable element highlighted.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'elements of',
    meaning: [
      'Essential components or parts.',
      'Fundamental constituents analyzed.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'his or her',
    meaning: [
      'Gender-neutral singular possession.',
      'Belonging to he/she individually.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    ...
    word: 'he or she',
    meaning: [
      'Gender-neutral singular subject.',
      'Individual person referenced.',
    ],
    partOfSpeech: ['phrase'],
  ...
  },
  {
    audioData: [' ', ''],
    word: 'men and women',
    meaning: ['Both genders collectively.', 'All adults regardless of sex.'],
    partOfSpeech: ['phrase'],
    simpleDefinition: ['People.', 'Adults.'],
    examples: [
